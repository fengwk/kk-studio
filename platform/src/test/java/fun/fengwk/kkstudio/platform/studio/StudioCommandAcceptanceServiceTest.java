...
class StudioCommandAcceptanceServiceTest {
  ...
  private static final StudioOwner CHAT_OWNER = new StudioOwner(StudioOwnerType.CHAT, CHAT_ID);
  private static final StudioOwner CANVAS_OWNER =
      new StudioOwner(StudioOwnerType.CANVAS, CANVAS_ID);
  ...
  private StudioCommandAcceptanceService service;
  ...
  void setUp() {
    ...
    service =
        new StudioCommandAcceptanceService(
  ...
  private AcceptancePreflight acceptAndCapturePreflight(
      StudioOwner owner, AcceptCommandsCommand command) {
