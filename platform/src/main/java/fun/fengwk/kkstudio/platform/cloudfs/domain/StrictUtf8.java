...
public final class StrictUtf8 {
   ...
   *
   * @param s 待编码字符串，非空
   * @param errorContext 错误上下文描述，非空
   * @return 严格编码后的 UTF-8 字节数组
   * @throws CloudFileSystemValidationException 遇非法字符或未配对 surrogate 时抛出
   */
  public static byte[] encode(String s, String errorContext) {
    ...
    try {
      ...
      throw new CloudFileSystemValidationException("Invalid UTF-8 encoding in " + errorContext, e);
    }
  }
}
