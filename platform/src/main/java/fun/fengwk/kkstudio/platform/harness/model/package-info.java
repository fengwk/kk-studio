 ...
 * 的生产适配器。
 *
 * <p>{@link fun.fengwk.kkstudio.platform.harness.model.PlatformModelGateway} 是 {@link
 * fun.fengwk.kkstudio.harness.runtime.port.ModelGateway} 的生产适配器：它通过 {@link
 * fun.fengwk.kkstudio.platform.harness.model.ProviderResolutionService} 解析冻结 {@link
 ...
 *
 * <p>{@link fun.fengwk.kkstudio.platform.harness.model.ModelExecutionConfiguration} 拥有共享虚拟线程
 * executor；busy 重试延迟由 {@link fun.fengwk.kkstudio.platform.harness.model.PlatformModelGateway} 在每次
 * start 从 SystemSettingsSnapshot 现读。两个适配器的 Provider I/O 都运行在该 executor 上。
 */
