...
/**
 * Platform 端口：按 canonical {@link EnvironmentName} 请求 READY 的 live Environment
 * 浏览一层目录（control-plane，不走 Tool Invocation/Permission，不占 active tool slot，可与 active invocation 并行）。
 */
