package fun.fengwk.kkstudio.platform.harness.subagent;
...
public final class SubagentRunRegistry {
  ...
  public void publishStatus(RelayedStatus status) {
  ...
  public synchronized List<RelayedStatus> descendantStatuses(UUID ancestorThreadId) {
  ...
  public record RelayedApproval(UUID invocationId, String toolName, String reason) {
    public RelayedApproval {
  ...
  public static final class Reservation implements AutoCloseable {
    ...
    public void attach(UUID threadId) {
