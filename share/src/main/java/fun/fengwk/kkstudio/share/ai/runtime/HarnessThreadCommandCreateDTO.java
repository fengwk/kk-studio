...
public class HarnessThreadCommandCreateDTO {
   ...
   * / SET_MODEL / SET_THINKING_LEVEL / SET_ACTIVE_TOOLS / SET_YOLO / SET_ENVIRONMENT；mapper 按类型严格校验
   * required/forbidden 字段。
   */
  private String type;
  ...
  /** 目标 thinking level：仅 SET_THINKING_LEVEL 必填；其余类型禁止提供。 */
