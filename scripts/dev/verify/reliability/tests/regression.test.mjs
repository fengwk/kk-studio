...
const RUNNER = path.join(REPO_ROOT, 'scripts/dev/verify/reliability/regression.sh')
...
test('regression CLI help is executable without starting Maven', () => {
  ...
  assert.match(result.stdout, /Usage: scripts\/dev\/verify\/reliability\/regression\.sh/)
