...
from scripts.ops.database_rebuild_source import (
...
SCRIPT = REPOSITORY_ROOT / "scripts" / "ops" / "rebuild-database.sh"
SOURCE_TOOL = REPOSITORY_ROOT / "scripts" / "ops" / "database_rebuild_source.py"
V1_MIGRATION = (
    REPOSITORY_ROOT
    / "schema"
    / "src"
...
"""
    ...
    def test_unexpected_failures_report_only_the_failure_type(self):
        ...
        module = importlib.import_module("scripts.ops.database_rebuild_source")
    ...
    def test_backup_output_inside_repository_is_rejected(self):
        ...
        command = f"""
source {shlex.quote(str(SCRIPT))}
WORK_DIR="$REPO_ROOT/runtime/rebuild-database"
...
"""
    ...
    def test_no_default_follower_container(self):
