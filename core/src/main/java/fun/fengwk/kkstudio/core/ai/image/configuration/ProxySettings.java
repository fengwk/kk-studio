...
public final class ProxySettings {
  ...
  private ProxySettings(
      ProxyTarget httpProxy, ProxyTarget httpsProxy, List<NoProxyRule> noProxyRules) {
  ...
  private static List<NoProxyRule> resolveNoProxy(
  ...
  private static ProxyTarget resolveProxy(
      Map<String, String> env, String lowerEnvName, String upperEnvName) {
    String rawValue = firstNonBlank(env.get(lowerEnvName), env.get(upperEnvName));
    if (isBlank(rawValue)) {
      return null;
