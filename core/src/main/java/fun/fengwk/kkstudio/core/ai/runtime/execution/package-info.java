 ...
 *
 * <ul>
 *   <li>{@link fun.fengwk.kkstudio.core.ai.runtime.execution.ExecutionTargetRow} — immutable row
 *       projection handed to handlers.
 *   <li>{@link fun.fengwk.kkstudio.core.ai.runtime.execution.ExecutionTargetStore} — narrow port:
 ...
 *   <li>{@link fun.fengwk.kkstudio.core.ai.runtime.execution.ExecutionTargetHandler} — synchronous
 *       per-row handler invoked outside any transaction. Returning {@code false} reports a stale
 *       snapshot.
 *   <li>{@link fun.fengwk.kkstudio.core.ai.runtime.execution.ExecutionTargetRouteEligibility} —
 *       read-only snapshot of locally READY route keys.
 *   <li>{@link fun.fengwk.kkstudio.core.ai.runtime.execution.PostgresqlExecutionTargetDispatcher} —
 ...
 *   <li>{@link fun.fengwk.kkstudio.core.ai.runtime.execution.PostgresqlExecutionTargetListener} —
