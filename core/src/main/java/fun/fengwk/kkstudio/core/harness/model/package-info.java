 ...
 * fun.fengwk.kkstudio.core.agent.provider.service.model.AgentProvider} primary key). It must never
 * consult {@link fun.fengwk.kkstudio.core.agent.model.repo.AgentModelRepository}, agent
