...
/**
 * Strict parser for the bigint ids exposed by the harness API. Rejects null, blank, non-decimal
 * or non-positive values with IllegalArgumentException, mapping to HTTP 400.
 */
