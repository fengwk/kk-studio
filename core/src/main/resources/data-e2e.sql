-- E2E provider/model seed.
-- base_url / credential intentionally null: inject from env at process start only when configured.
-- Model limits/pricing adapted from pi model catalogs for LangChain4j runtime.
...
-- Shared config fragments (limit/abilities/pricing/variants) follow pi model metadata.
