...
public class S3ObjectKeyNormalizerTest {
    ...
    public void shouldRejectBlankAndLeadingSlash() {
        ...
        assertThrows(IllegalArgumentException.class, () -> S3ObjectKeyNormalizer.normalize("   "));
        assertThrows(
                IllegalArgumentException.class, () -> S3ObjectKeyNormalizer.normalize("/file"));
    }
    ...
    public void shouldRejectDotSegmentsAndControls() {
        assertThrows(
                ...
                () -> S3ObjectKeyNormalizer.normalize("dir/./file"));
        assertThrows(
                IllegalArgumentException.class,
                () -> S3ObjectKeyNormalizer.normalize("dir/../file"));
        assertThrows(
                IllegalArgumentException.class,
                () -> S3ObjectKeyNormalizer.normalize("dir/\nfile"));
        assertThrows(
                IllegalArgumentException.class,
                () -> S3ObjectKeyNormalizer.normalize("dir/\u0085file"));
    }
    ...
    public void shouldEnforceUtf8ByteLength() {
        ...
        assertThrows(
                IllegalArgumentException.class,
                () -> S3ObjectKeyNormalizer.normalize(multibyteOverLimit));
    }

    @Test
    public void shouldPreserveValidObjectKeyExactly() {
        assertEquals(
                "目录/.hidden/file.v2.png",
                S3ObjectKeyNormalizer.normalize("目录/.hidden/file.v2.png"));
    }
}
