...
insert into environment (
    ...
    ('11111111-1111-1111-1111-111111111111'::uuid, 'tool-e2e', 'e2e-token-host-tool-e2e', current_timestamp, current_timestamp, 0),
    ('22222222-2222-2222-2222-222222222222'::uuid, 'docker-reliability', 'e2e-token-docker-reliability', current_timestamp, current_timestamp, 0),
    ('33333333-3333-3333-3333-333333333333'::uuid, 'distributed-a', 'e2e-token-distributed-a', current_timestamp, current_timestamp, 0),
    ('44444444-4444-4444-4444-444444444444'::uuid, 'distributed-b', 'e2e-token-distributed-b', current_timestamp, current_timestamp, 0)
