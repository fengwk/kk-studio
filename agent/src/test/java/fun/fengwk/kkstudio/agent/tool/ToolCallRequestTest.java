...
public class ToolCallRequestTest {
    ...
    public void testAcceptsArgumentsMatchingSchema() {
        ToolCallRequest request = new ToolCallRequest("call_1", "echo", "{\"text\":\"OK\",\"count\":1,"
            + "\"score\":1.5,\"enabled\":true,\"mode\":\"fast\",\"tags\":[\"a\"],"
            + "\"meta\":{\"traceId\":\"tr_1\"}}", structuredSchema());
    ...
    public void testRejectsArgumentsViolatingNestedSchema() {
        ...
        assertSchemaError("{\"text\":\"OK\",\"meta\":{\"traceId\":\"tr_1\",\"extra\":1}}",
    ...
    public void testRejectsInvalidSchemaRequiredName() {
        ...
        assertEquals("invalid tool inputSchema: required property name must not be blank: $", error.getMessage());
    }
