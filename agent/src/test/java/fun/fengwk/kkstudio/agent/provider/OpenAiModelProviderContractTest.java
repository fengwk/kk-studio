 ...
 * @author fengwk
 */
public class OpenAiModelProviderContractTest extends AbstractProviderContractTestSupport {

    /**
     * 指定当前 contract test 目标为 OpenAI 兼容 provider。
     */
    @Override
    ...
    /**
     * 返回 OpenAI 兼容协议测试使用的 BASE_URL 环境变量名。
     */
    @Override
    protected String baseUrlEnvName() {
        return "TEST_OPENAI_BASE_URL";
    }

    /**
     * 返回 OpenAI 兼容协议测试使用的 API_KEY 环境变量名。
     */
    @Override
