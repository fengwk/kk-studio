...
public class GuardedToolExecutionHandlerTest {
    ...
    public void testRejectsMalformedPartialVariants() {
        assertPartialError(Collections.singletonList((IndexedToolContentDelta) null), "null_tool_content_delta_item");
    ...
    public void testConstructorRejectsNullArguments() {
        ...
        assertThrows(IllegalArgumentException.class,
            () -> new GuardedToolExecutionHandler(null, fixture.listener, fixture.handle, fixture.terminalCounter::incrementAndGet));
        assertThrows(IllegalArgumentException.class,
            () -> new GuardedToolExecutionHandler(new ToolCallRequest("call_1", "echo", "{}"), null, fixture.handle, fixture.terminalCounter::incrementAndGet));
        assertThrows(IllegalArgumentException.class,
            () -> new GuardedToolExecutionHandler(new ToolCallRequest("call_1", "echo", "{}"), fixture.listener, null, fixture.terminalCounter::incrementAndGet));
        assertThrows(IllegalArgumentException.class,
            () -> new GuardedToolExecutionHandler(new ToolCallRequest("call_1", "echo", "{}"), fixture.listener, fixture.handle, null));
    }

    private static void assertPartialError(List<IndexedToolContentDelta> partial, String expectedReason) {
        Fixture fixture = new Fixture();
    ...
    private static IndexedToolContentDelta mediaDelta(int index, ToolContentType type, String data, String mime) {
        ToolContentDelta contentDelta = new ToolContentDelta();
    ...
    private static class Fixture {
        ...
        private final GuardedToolExecutionHandler handler = new GuardedToolExecutionHandler(
