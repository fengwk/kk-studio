...
DISTRIBUTED_DAEMON_A_REGISTRATION_TOKEN=${DISTRIBUTED_DAEMON_A_REGISTRATION_TOKEN:-e2e-token-distributed-a}
DISTRIBUTED_DAEMON_B_REGISTRATION_TOKEN=${DISTRIBUTED_DAEMON_B_REGISTRATION_TOKEN:-e2e-token-distributed-b}
