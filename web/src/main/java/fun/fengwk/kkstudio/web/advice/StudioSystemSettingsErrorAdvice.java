...
import fun.fengwk.kkstudio.core.systemsettings.SystemSettingsDomainException;
import fun.fengwk.kkstudio.core.systemsettings.SystemSettingsResourceNotFoundException;
import fun.fengwk.kkstudio.core.systemsettings.SystemSettingsValidationException;
import fun.fengwk.kkstudio.core.systemsettings.SystemSettingsVersionConflictException;
 ...
 * fun.fengwk.kkstudio.core.systemsettings.SystemSettingsErrorCode} 派生的稳定机器可读 {@code code}。HTTP 状态：
