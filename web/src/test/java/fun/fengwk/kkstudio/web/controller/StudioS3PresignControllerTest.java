 ...
 *
 * <p>启用 {@code kk-studio.storage.s3.enabled=true} 后走完整的 {@link
        ...
        mockMvc.perform(
                ...
                .andExpect(
                        jsonPath("$.data.url")
                                .value(
                                        startsWith(
                                                "https://cdn.example.com/test-bucket/uploads/demo.bin")))
        ...
        mockMvc.perform(
                ...
                .andExpect(
                        jsonPath("$.data.url")
                                .value(
                                        startsWith(
                                                "https://cdn.example.com/test-bucket/exports/report.pdf")))
                .andExpect(jsonPath("$.data.url").value(containsString("X-Amz-Signature=")));
    }
