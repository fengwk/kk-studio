...
class PromptTemplateTest {
  ...
  private static final String GREETING = "fun/fengwk/kkstudio/harness/prompt/greeting.txt";
  private static final String UNTERMINATED = "fun/fengwk/kkstudio/harness/prompt/unterminated.txt";
  private static final String INVALID_NAME = "fun/fengwk/kkstudio/harness/prompt/invalid-name.txt";
  ...
  void rejectsMissingResource() {
    IllegalArgumentException error =
        assertThrows(
            ...
            () -> loader.load("fun/fengwk/kkstudio/harness/prompt/missing.txt"));
