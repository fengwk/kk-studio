...
public final class McpBridgeTools {
  ...
  public static void registerAll(
      DaemonToolRegistry registry, McpServerRegistry mcpRegistry, ExecutorService executor) {
    Objects.requireNonNull(registry, "registry");
    Objects.requireNonNull(mcpRegistry, "mcpRegistry");
    Objects.requireNonNull(executor, "executor");
    registry.register(new McpListToolsTool(mcpRegistry, executor));
    registry.register(new McpCallToolTool(mcpRegistry, executor));
  }
}
