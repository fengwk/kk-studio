...
class PromptTemplateTest {
  ...
  private static final String GREETING = "fun/fengwk/kkstudio/harness/runtime/prompt/greeting.txt";
  private static final String UNTERMINATED =
      "fun/fengwk/kkstudio/harness/runtime/prompt/unterminated.txt";
  private static final String INVALID_NAME =
      "fun/fengwk/kkstudio/harness/runtime/prompt/invalid-name.txt";
  ...
  void rejectsMissingResource() {
    IllegalArgumentException error =
        assertThrows(
            ...
            () -> loader.load("fun/fengwk/kkstudio/harness/runtime/prompt/missing.txt"));
