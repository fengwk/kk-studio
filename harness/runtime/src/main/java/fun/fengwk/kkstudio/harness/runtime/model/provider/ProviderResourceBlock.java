 ...
 * attempt 物化（core 的 ProviderResourceMaterializer）在每次 attempt 时按 {@code storage_blob} 事实把它转换为携带新鲜预签名
 * HTTPS URL 的 image/audio/video 块，或确定性文本回退——生成的 URL 只存在于本次 attempt 的有效请求，绝不持久化。
 */
