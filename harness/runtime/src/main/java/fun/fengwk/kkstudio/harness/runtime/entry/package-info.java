 ...
 * Agent 名称引用、{@link fun.fengwk.kkstudio.harness.runtime.entry.ModelSelection} 与可空 Environment name
 * 等 branch 事实；{@link fun.fengwk.kkstudio.harness.runtime.entry.TurnStartReason} / {@link
