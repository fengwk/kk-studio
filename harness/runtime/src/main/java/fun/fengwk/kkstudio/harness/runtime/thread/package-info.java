 ...
 * ThreadContext} 上下文（terminal apply / Work-only 挂起 / continuation / 输入或静止）；{@link
 * ThreadRuntimeStatus} 是该上下文唯一的对外状态投影。不变量被破坏的形状抛 {@link IllegalStateException}。ThreadProcessor 与
 * root 包的 HarnessRuntime 控制面通过共享的锁定上下文辅助（ {@code
