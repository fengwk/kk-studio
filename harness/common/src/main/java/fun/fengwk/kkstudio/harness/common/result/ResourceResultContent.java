...
/**
 * 指向规范 Resource URI 的结果内容单元；可选 preview 让调用方在不读取资源正文的情况下展示有界文本。
 *
 * <p>引用校验在 {@link ResourceRef} 构造时完成；preview 使用严格 Unicode / UTF-8 字节上限。
 */
public record ResourceResultContent(ResourceRef resource, String preview) implements ResultContent {
